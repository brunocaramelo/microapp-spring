...
import com.microapp.microapp.controllers.SalesController;
...
public class SalesApiTest {
    ...
    @Autowired
    private SalesController localController;

    private MockMvc mockMvc;


    private final  String urlAllItem = "/api/sales/?page=0&pageSize=10";

    private final  String urlOneItem = "/api/sales/4";

    private final  String fielToAnalize = "quantitySold";
